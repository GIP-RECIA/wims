...
!set name_failuredeletefile=is NIET verwijderd uit de module
...
!set name_images=Algemene afbeeldingen (plaatjes)
!set name_help_images=Als er afbeeldingen (plaatjes) opgenomen moete nworden in een oefening
...
!if $job iswordof modname restore
  ...
  !distribute lines Laat alleen modules zien waarvan het adres bevat\
    Klik op de titel of het adres van een module, om deze te gaan bewerken\
...
!if $job iswordof copy move
  !set name_warning1=Het veranderen van de modulenaam zal \
    leiden tot problemen met werkbladen, repetities en documenten die deze module gebruiken.
...
!if $job=auth
  !set name_intro=Dit hulpprogramma is bedoeld voor het online ontwikkelen van speciale WIMS modules,\
    ...
    Geef hier s.v.p. uw modtool loginnaam
...
:del
  !set name_delmodule_warning1=Verwijderde modules zijn definitief weg ! Maak dus eerst een
  !set name_delmodule_warning2=<b>Attentie</b>: wanneer deze module nog in gebruik is in werkbladen,\
    repetities of documenten wordt dit lesmateriaal dus onbruikbaar !
  !set name_delmodule_confirm=Weet U zeker dat deze module verwijderd moet worden
!exit
