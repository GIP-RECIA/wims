...
name_groupAverage
!set name_dtexolog=Laatste toegevoegde oefening
...
!!!set name_thsheet=No,Titel,Vereist,Weging,Punten<br>verkregen, % , Kwaliteit , Moeilijkheidsgraad , Cijfer ,Hoogste cijfers, Aantal pogingen, Laatste resultaat, Vereiste niveau
...
!set name_auto=Gemiddelde score op de geselecteerde werkbladen<br>en examens, met inachtneming van de wegingen.
...
!set name_warning=Uw verzoek is ongeldig en kan niet worden uitgevoerd.
...
!if $job=examcheck
 ...
 !set name_no_exampart=Hier staan alle proefwerksessies van deze student.\
...
!if $job=csv
  !distribute lines Hier is het bestand\
    ...
    Voornieuwe deelnemers is de wachtwoordkolom verplicht.\
