...
!distribute line Elija el tipo de contraseña\
  ...
  Only required when changing su contraseña personal\
...
name_desc_forcechpwd=Votre mot de passe actuel a été défini par le serveur (procédure d'expédition de mot de passe par message électronique) \
ou par votre enseignant. Vous devez définir un nouveau mot de passe pour garantir la sécurité de votre compte.
name_desc_forcechpwd2=Votre mot de passe actuel a été défini par le serveur procédure d'expédition de mot de passe par message électronique) \
ou par l'administrateur du groupement/portail. Vous devez définir un nouveau mot de passe pour garantir la sécurité de votre compte.
